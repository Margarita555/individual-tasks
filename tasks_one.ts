...
type MyCallback = (num: number) => boolean;
...
// function deleteString(matrix, value: number) {
//   if (matrix.length === 0) {
//     return [];
//   }
...
// function deleteColumn(matrix, value: number) {
//   if (matrix.length === 0) {
//     return [];
//   }
...
// function countSum(matrix, callback): number {
...
// function countZeroElements(matrix, callback): number {
//   if (callback && typeof callback !== "function") {
//     throw new Error("Callback is not found");
//   }
